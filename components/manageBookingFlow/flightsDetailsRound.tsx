...
import styles from './flightDetailsRound.module.css';
          ...
          <Box className={styles.box}>
            <DialogTitle>
              <Box className={styles.dialogFlex}>
                <Typography className={styles.Titiles}>
                  Flight Details
                </Typography>
                <Box className={styles.Titiles}>
                  <Button>
              ...
              <Typography className={styles.dilCon}>
                Round trip • Bengaluru to Delhi • 18-19 Feb, 2022
              </Typography>
...
export default FlightsdetailsRound